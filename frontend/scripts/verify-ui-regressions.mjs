...
const checks = [
  ...
  {
    name: "Kafka Continuous jobs preserve a separate dashboard sync cadence",
  ...
  {
    name: "Kafka Continuous source settings expose dashboard sync minutes",
    file: "src/pages/etl/EtlPages.tsx",
    patterns: [
      /label="대시보드 자동 동기화 주기"/,
  ...
  {
    name: "Kafka Continuous runtime shows the saved dashboard sync cadence",
    file: "src/pages/ingest/JobsPages.tsx",
    patterns: [
      /label="대시보드 동기화"/,
      /job\.continuousConfig\?\.dashboardSyncIntervalMinutes \?\? 5/,
    ],
  },
  {
    ...
    patterns: [
      ...
      /if \(!revisionId\) \{[\s\S]*?setPublishedRefreshStatus\("manual"\)/,
  ...
  {
    name: "Published dashboard refresh uses scoped live data requests",
    file: "src/services/dashboardRuntimeApi.ts",
    patterns: [
      ...
      /apiClient\.get<DashboardPublishedDataResponse>/,
    ],
    forbiddenPatterns: [
      /apiConfig/,
      /runtimeStore/,
  ...
  {
    name: "Published dashboard refresh response exposes scope and scheduling fields",
  ...
  {
    name: "Published dashboard sync status shows dynamic minutes and manual mode",
    file: "src/pages/dashboard/runtime/DashboardTopBar.tsx",
    patterns: [
      /자동 동기화 · \$\{autoRefreshIntervalMinutes \?\? "-"\}분/,
      /Kafka 자동 동기화 없음/,
      /탭 숨김 · 일시정지/,
      /hasPublishedRevision === false[\s\S]*?\? "manual"/,
      /aria-label="대시보드 전체 동기화"/,
      /title="대시보드 전체 동기화"/,
      /effectivePublishedRefreshStatus === "error" \? "destructive"/,
      /aria-label=\{`\$\{publishedRefreshStatusLabel\}/,
    ],
  },
  {
    name: "Published dashboard manual sync refreshes the entire dashboard once",
    file: "src/pages/dashboard/DashboardPage.tsx",
    patterns: [
      /refreshPublishedWidgetData\(/,
      /"all"/,
      /\/published\/data\?scope=all/,
      /대시보드 전체 데이터를 동기화했습니다/,
    ],
  },
  {
