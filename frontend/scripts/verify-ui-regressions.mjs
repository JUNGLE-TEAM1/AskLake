...
const checks = [
  ...
  {
    name: "Production login starts without demo credentials and gates public signup explicitly",
  ...
  },
  {
    ...
    patterns: [
      ...
      /assetMeta\.trim\(\)\.toLowerCase\(\) === "folder" \|\| assetPath\.endsWith\("\/"\)/,
  ...
  },
  {
    ...
    forbiddenPatterns: [/VITE_USE_MOCK_API/, /useMock/, /resolveMockApiMode/, /localhost:8080/],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      ...
      /export function buildReviewSnapshotRequest\(draft: DraftPipeline\)/,
