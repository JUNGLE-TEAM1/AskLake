...
const checks = [
  {
    name: "SQL analysis uses inline chart settings, an AI SQL dialog, and an in-dialog Job wizard",
  ...
  {
    name: "SQL chart configurator exposes four chart types and explicit apply",
  ...
  {
    name: "Nessie SQL writer dialog generates a preview before applying it",
  ...
  },
  {
    ...
    patterns: [
      ...
      /\.sql-result-panel\.has-result[\s\S]*grid-template-rows:\s*max-content max-content minmax\(0, 1fr\);/,
