...
const checks = [
  ...
  {
    name: "AI workspace persists live conversations and keeps the governed mock suggestion path",
    ...
    patterns: [
      ...
      /listAiConversations\(\)\.then\(async \(\{ items \}\)/,
      ...
      /finally \{[\s\S]*setConversationPending\(conversation\.id, false\);/,
    ...
    forbiddenPatterns: [/runtimeUnavailable/, /prompt_drafted/, /localStorage/, /sessionStorage/],
  },
  {
