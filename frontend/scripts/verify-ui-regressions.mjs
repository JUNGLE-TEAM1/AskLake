...
const checks = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /<SqlChartEmptyState \/>/,
      /data-sql-result-scroll="main"[\s\S]*scrollbars="both"[\s\S]*type="auto"/,
      /data-sql-result-scroll="dialog"[\s\S]*scrollbars="both"[\s\S]*type="auto"/,
      ...
      /\{progressContent \? \([\s\S]*\{resultToolbar\}/,
      /\{progressContent\}[\s\S]*\{emptyStateContent \?\?/,
    ],
    forbiddenPatterns: [
      /<PanelHeader/,
      /title="결과 대기 중"/,
