    ...
    <div className="app-shell" data-last-action={auditSignal}>
      ...
      <main className="main-shell">
        ...
        <section className={activeFlow === "jobs" ? "page-body jobs-body" : "page-body"}>
          ...
          {isScheduleFlow(activeFlow) && <SchedulePage draftScheduleLabel={draftPipeline.scheduleLabel} mode={activeFlow} onDraftChange={updateDraftPipeline} onPrev={() => moveToFlow("rules")} onModeChange={moveToFlow} onNext={() => moveToFlow("permission")} onSave={() => saveDraft(activeFlow)} />}
