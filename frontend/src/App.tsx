    ...
    <div className="app-shell" data-last-action={auditSignal}>
      ...
      <main className={activeFlow === "schema" ? "main-shell schema-shell" : "main-shell"}>
        ...
        <section className={activeFlow === "jobs" ? "page-body jobs-body" : activeFlow === "schema" ? "page-body schema-body" : "page-body"}>
          ...
          {activeFlow === "catalog" && <CatalogPage datasets={datasets} selectedDataset={selectedDataset} onAction={writeAuditLog} onCreateDashboard={(dataset) => openDashboardBuilder("catalog", "catalog.dashboard.create_requested", `/api/catalog/datasets/${dataset.id}/dashboards`, dataset)} onDatasetOpen={openDataset} onOpenSql={openDatasetInSql} />}
