...
>(({ className, ...props }, ref) => (
  <strong
    className={cn("min-w-0 truncate text-sm font-semibold text-slate-950", className)}
    ref={ref}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <span
    className={cn("min-w-0 truncate text-xs font-medium text-slate-500", className)}
    ref={ref}
    {...props}
  />
));
