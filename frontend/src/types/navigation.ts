...
export type FlowId = "jobs" | "jobsTableDemo" | "jobDetail" | "jobRuns" | "source" | "schema" | "rules" | "repeat" | "manual" | "once" | "target" | "permission" | "review" | "catalog" | "catalogDetail" | "sql" | "dashboard" | "ai" | "admin";
