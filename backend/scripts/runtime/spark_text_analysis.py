"""Spark text-structuring, review-analysis, and classifier runtime.

This module has no entrypoint. ``spark_job_runtime`` re-exports its public
functions for compatibility with existing callers.
"""
...
__all__ = [
    ...
    'apply_review_row_analysis_group',
    'apply_transform_steps',
    'call_local_review_llm',
    'canonical_allowed_value',
    'cast_for_schema',
    'classifier_condition_needs_pattern',
    'classifier_numeric_condition',
    'classifier_pattern_is_number',
    'clean_review_text',
    'contains_row_analyze_call',
    'contiguous_review_row_analysis_group',
    'custom_csv_classifier_condition',
    'custom_csv_classifier_expression',
    'custom_csv_classifier_fallback',
    'evaluate_custom_csv_classifier_checks',
    'evaluate_review_row_analysis_checks',
    'evaluate_text_structuring_quality',
    'first_matching_column',
    'is_custom_csv_classifier_step',
    'is_review_row_analysis_step',
    'is_row_analysis_operation',
    'load_review_text_model',
    'local_copy_or_extract_value',
    'local_llm_review_row_analysis_expression',
    'local_llm_review_row_analysis_payload_expression',
    'local_llm_review_row_target',
    'merge_text_structuring_quality',
    'nested_field_exists',
    'normalize_column_name',
    'normalize_review_analysis_llm_columns',
    'normalize_review_row_analysis_method',
    'parse_custom_csv_classifier_config',
    'parse_json_array',
    'parse_json_object',
    'parse_review_row_analysis_config',
    'plan_review_row_analysis_checks',
    'portable_dense_features_from_values',
    'portable_review_text_features',
    'portable_review_text_predict',
    'quote_identifier',
    'resolve_column_name',
    'resolve_review_text_model_path',
    'review_allowed_value_condition',
    'review_analysis_config_source_fields',
    'review_analyze_source_fields',
    'review_copy_expression',
    'review_instruction_expression',
    'review_one_of_values_expression',
    'review_portable_text_model_expression',
    'review_row_analysis_allowed_values',
    'review_row_analysis_check_payload',
    'review_row_analysis_column_config',
    'review_row_analysis_execution_mode',
    'review_row_analysis_expected_values',
    'review_row_analysis_expression',
    'review_row_analysis_fallback_allowed',
    'review_row_analysis_group_columns',
    'review_row_analysis_method',
    'review_row_analysis_model_artifact',
    'review_row_analysis_model_selection_policy',
    'review_row_analysis_uses_local_llm',
    'review_source_text_present',
    'review_text_model_metrics',
    'review_text_model_required',
    'safe_col',
    'safe_float',
    ...
    'spark_sql_type',
    'sparse_dot',
    'text_structuring_definition_from_steps',
    'text_structuring_execution_summary',
    'text_structuring_invalid_condition',
    'text_structuring_manifest',
    'truncate_text',
    'truthy',
    'try_cast_double',
    'try_cast_type',
    'unique_column_name',
    'unique_temp_column',
    'write_text_structuring_quarantine',
]
