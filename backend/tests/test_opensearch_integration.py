...
def test_opensearch_2191_rag_contract_when_enabled():
    ...
    mapping = {"settings": {"index": {"knn": True}}, "mappings": {"properties": {"document_id": {"type": "keyword"}, "parent_document_id": {"type": "keyword"}, "body": {"type": "text"}, "embedding_text": {"type": "text"}, "body_vector": {"type": "knn_vector", "dimension": 2}, "metadata_filter": {"type": "object", "dynamic": False, "properties": {"rating": {"type": "object", "dynamic": False, "properties": {"number": {"type": "double"}, "keyword": {"type": "keyword"}}}}}, "source_fields": {"type": "object", "dynamic": False, "properties": {"logicalField": {"type": "keyword"}, "physicalField": {"type": "keyword"}, "role": {"type": "keyword"}}}, "embedding_input_version": {"type": "keyword"}, "field_rendering_version": {"type": "keyword"}, "chunk_index": {"type": "integer"}, "chunk_count": {"type": "integer"}, "char_start": {"type": "integer"}, "char_end": {"type": "integer"}, "embedding_model": {"type": "keyword"}, "embedding_dimensions": {"type": "integer"}}}}
