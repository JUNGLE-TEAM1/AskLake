...
class ContinuousSqlPublicationService:
    ...
    def _catalog_dataset(
        ...
        values = {
            ...
            "producer_job_kind": "continuous_sql",
            "execution_mode": "continuous",
            "source_kind": "continuous_sql",
            "relation_mode": "static",
            "runtime_status": job.observed_state,
            "rows": payload["rows"],
            "size": payload["size"],
    ...
    def _catalog_payload(
        ...
        payload: dict[str, Any] = {
            **previous_payload,
            ...
            "producerJobKind": "continuous_sql",
            "executionMode": "continuous",
            "sourceKind": "continuous_sql",
            "runtimeStatus": job.observed_state,
