...
class CatalogDatasetModel(TimestampMixin, Base):
    ...
    producer_job_id: Mapped[str | None] = mapped_column(String(160), nullable=True, index=True)
    producer_job_kind: Mapped[str | None] = mapped_column(String(64), nullable=True)
    ...
    relation_mode: Mapped[str | None] = mapped_column(String(32), nullable=True)
