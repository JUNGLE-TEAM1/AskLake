...
def create_query_run(
    ...
    compatibility_payload = request.model_dump(by_alias=True, exclude_none=True)
    return service.create_query_run(QueryRunRequest.model_validate(compatibility_payload), actor)
