...
> **문서 상태 — 역사적 작업 기록 (2026-07-05)**
>
> 이 문서는 당시 Pair A의 하루 작업 분배와 임시 상태 계약을 보존한다. 현재 API와 Run command 기준은 [API Reference](../03-api-reference.md), [API Contract](../api-contract.md), [ETL Job Command Boundary](../refactor-2026/contracts/etl-job-command-boundary.md)를 따른다.
