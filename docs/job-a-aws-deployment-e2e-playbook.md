...
| 2026-07-14 | Issue #707 1GB source-scan benchmark | `fix-#707-scan-reduction` / `7392bf53` | `click_events_1gb.jsonl` 972,951,366 bytes, 3,112,448 rows, 8 Spark ranges | input/output 3,112,448행, raw full scan 7→3회, Spark 101.997→70.538초(-30.8%), NetworkIn 약 6.83→2.92 GiB(-57.3%), CPU 평균 84.82%·최대 100%, memory 최대 34.92% | Run `run_44b75baf7bad`; deploy SSM `927572ea-c692-4483-8c4a-3eccf38c9cae`; submit SSM `9a65ae94-0dfd-491d-8ccd-6b9840fa98af`; 24 FileScanRDD lines / 8 ranges SSM `6c716801-cca9-4cd5-ba7a-7deb300ba167`; local raw 1초 export `output/benchmarks/issue-707/run_44b75baf7bad/cloudwatch-1s.json` | 3회 예산은 현재 단일 cast transform-only Snapshot 기준이며 다중 transform/quality action batching은 별도 확장 필요 |
