...
- SQL 분석 화면 안의 Query AI 보조 기능: 자연어 요청 기반 SQL 초안 제안
...
| Query AI 보조 | 선택 테이블 context와 자연어 요청으로 read-only SQL 초안을 생성 | Medium | `docs/api-contract.md` |
...
4. 사용자는 선택 테이블과 schema context를 기반으로 Query AI 보조 기능에서 SQL 초안을 받을 수 있다.
