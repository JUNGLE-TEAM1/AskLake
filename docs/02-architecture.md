...
| Lineage graph | React Flow (`@xyflow/react`) | implemented | catalog lineage modal with column-level handles, selectable source hints, and selected-column emphasis |
