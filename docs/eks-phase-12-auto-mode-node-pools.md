...
7/17 실제 FastAPI HPA와 동시 Spark workload로 확장·축소를 검증하기 전 Git/live 차이, 현재 pool 용량과 공유 환경 경합은 [Pair A autoscaling 기준선](eks-day17-a-autoscaling-baseline.md)을 따른다. Day 14 synthetic General scale 증거를 금요일의 전체 workload autoscaling 완료로 확대 해석하지 않는다.
