...
| R-003 | P1 | `etl_service.py` God Service | 8,822→8,590 LOC. 외부 I/O·runtime·publication에 이어 Job query와 create/update/delete write를 application module로 분리; SQL·실행·발행 경계는 후속 | 04~07, #864, #866, #868+ | PARTIAL |
