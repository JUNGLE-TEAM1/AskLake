...
| R-003 | P1 | `etl_service.py` God Service | 8,822→8,389 LOC. 외부 I/O·Continuous publication에 이어 Job query/write, Airflow 실행·Catalog 발행과 Source connector use case를 application module로 분리; SQL Job 생성·snapshot command composition은 후속 | 04~07, #864, #866, #868, #871, #873+ | PARTIAL |
