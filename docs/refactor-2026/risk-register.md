...
| R-004 | P1 | Continuous 상태 권위가 DB, container, report, checkpoint, manifest, Catalog에 분산 | desired/observed/public 상태, canonical writer와 fencing 계약 확정; 구현 분리는 04~06에서 계속 | 03~06 | PARTIAL |
