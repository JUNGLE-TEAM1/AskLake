...
| R-003 | P1 | `etl_service.py` God Service | 8,822→8,683 LOC. 외부 I/O·runtime·publication에 이어 Job query와 delete transaction을 application module로 분리; create/update와 실행 경계는 후속 | 04~07, #864, #866+ | PARTIAL |
