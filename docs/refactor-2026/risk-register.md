...
| R-003 | P1 | `etl_service.py` God Service | 8,822→8,399 LOC. 외부 I/O·Continuous publication에 이어 Job query, create/update/delete write, Airflow Spark 실행·Catalog 발행을 application module로 분리; SQL Job 생성·snapshot command composition은 후속 | 04~07, #864, #866, #868, #871+ | PARTIAL |
