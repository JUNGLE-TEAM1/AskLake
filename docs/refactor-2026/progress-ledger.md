...
- PR 07: `#875` / PR 생성 전 / `refactor-#875` — EKS·EC2 workload topology와 Kafka Continuous·Continuous SQL reconciliation의 단일-owner manifest/validator, `#874` 머지 대기 Draft 예정
