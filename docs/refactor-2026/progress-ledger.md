...
- 현재 PR 02: `#864` / `refactor-#864` — ETL Job list/detail refresh·hydrate·permission·facet application 경계
...
- 다음 단계: PR 02 검증·Draft 생성 뒤 ETL write command/transaction 경계를 별도 이슈/PR로 분리
