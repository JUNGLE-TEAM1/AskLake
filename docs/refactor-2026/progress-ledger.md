...
- 현재 PR 06: `#873` / `refactor-#873` — Source connector Python request/response use case와 기존 Node script transport의 typed gateway 권위 경계
...
- 다음 단계: PR 06 Draft 생성 후 Continuous control-plane owner와 EKS/EC2 이중 제어를 PR 07로 분리
