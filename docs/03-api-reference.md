...
| ´ë½Ãº¸µå | Postgres/API adapter state | `GET /api/dashboards`, `POST /api/dashboards/query`, `DELETE /api/dashboards/{dashboardId}`, draft/published revision runtime APIs |
