...
| Failure | How to fix |
| --- | --- |
| `npm run verify:ui-regressions` failed | SQL 분석의 Nessie 탭·차트 빌더·Job wizard, Catalog wide button, Dashboard 목록, ApexCharts 위젯의 최근 회귀 방지 스타일/렌더 계약을 확인하고 관련 파일을 수정한다. |
