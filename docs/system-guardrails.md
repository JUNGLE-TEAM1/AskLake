...
| Trino contract verification | matching backend/frontend paths | 100행 preview/PostgreSQL inline 저장, 요청형 full-result/S3 저장, Query Run, registration, collector fencing, actor reservation, timeline state | `verify:trino-query-foundation`, `verify:trino-preview-full-flow`, `verify:query-engine-registration`, `verify:trino-result-storage`, `verify:trino-collector-resilience`, `verify:trino-submission-guard`, `test:trino-timeline` pass |
