...
| Deploy dependency verification | manual | deploy Compose, backend image, frontend image, Spark image | `scripts/verify-deploy-dependencies.sh` passes before deploy |
