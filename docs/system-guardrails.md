...
| Deploy dependency verification | manual | deploy Compose, local Airflow Compose, backend image, frontend image, Spark image, Airflow image | `scripts/verify-deploy-dependencies.sh` passes before deploy |
