...
기준 브랜치: A03 `feat-#352`, B04 `feat-#350`, #357 `refactor-#357`, #361 `refactor-#361`, #364 `refactor-#364`, #367 `refactor-#367`, #369 `refactor-#369`, #375 `refactor-#375`, #378 `feat-#378`, #385 `feat-#385`, #387 `refactor-#387`, #389 `feat-#389`, #391 `refactor-#391`, #393 `refactor-#393`, #395 `refactor-#395`, #401 `refactor-#401`, #418 `refactor-#418`, #419 `refactor-#419`, #421 `refactor-#421` 확인 기준
...
| `frontend/src/styles/sql.css` | 1,255 | B | `부분 정리됨` | #468에서 sidebar tab, 상태 pill, raw action, Query AI state, embedded dashboard backdrop, empty/result surface CSS를 `Tabs`, `Badge`, `Button`, `Bubble`, `Dialog`, `Empty`, `Panel`, `Slider`로 이동해 2,547줄에서 1,255줄로 축소. 3-column workspace, dark SQL editor, tree/hover positioning, result table density, embedded Dashboard 크기 같은 도메인 layout CSS만 유지한다. |
...
| SQL editor/action buttons | `sql.css` | `부분 정리됨` | #468에서 raw action selector와 기존 button 색/테두리/둥근 pill CSS를 제거하고 `Button` variant에 맡겼다. editor/action/result group 배치와 좁은 폭 wrap처럼 layout CSS만 유지한다. |
...
| 2026-07-10 | #468에서 SQL 분석의 raw tab/action/status/empty/AI/dialog surface를 shadcn primitive로 교체하고 `sql.css`를 2,547줄에서 1,255줄로 축소. workspace/editor/tree/result density처럼 화면 동작에 필요한 layout selector만 유지. |
